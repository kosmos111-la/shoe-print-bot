...
    }
   
    // 🔥 ПЕРЕПИСАННЫЙ МЕТОД: добавить граф в шаблон
...
       
        // 2. 🔥 ИСПОЛЬЗУЕМ TEMPLATE BUILDER вместо старой логики
...
        }
       
        // 3. Оцениваем граф как кандидата на "лучший"
...
    }
   
    // 🔥 ОЦЕНИТЬ ГРАФ КАК КАНДИДАТА НА "ЛУЧШИЙ"
...
           
            // 🔥 ВАЖНО: Если новый лучший след значительно лучше, можно обновить эталон
            if (score > 0.8 && this.bestGraphScore > 0.6) {
                console.log(`🔄 Рассматриваю обновление эталона шаблона...`);
                // Можно добавить логику для обновления эталона при необходимости
            }
        }
    }
   
