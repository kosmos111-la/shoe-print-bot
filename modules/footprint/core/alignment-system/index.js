...
    // Дополнительные методы выравнивания для полноты
    static similarityAlignment(points, reference, options) {
        console.log('[AlignmentSystem] Similarity выравнивание');
        // Упрощенное similarity преобразование
        return this.simpleAlignment(points, reference, options);
    }

    static affineAlignment(points, reference, options) {
        console.log('[AlignmentSystem] Affine выравнивание');
        // Упрощенное affine преобразование
        return this.simpleAlignment(points, reference, options);
    }
}
