...
                    if (existingModel && modelIdHint) {
                        this.models.set(modelIdHint, existingModel);
                        if (this.debug) {
                            console.log(`💾 Модель ${modelIdHint.substring(0,12)} обновлена в хранилище (${existingModel.graph.nodes.size} узлов)`);
                        }
                    }
