...
class CenterMatcher {
    ...
    findCenterMatches(photoGraph, modelGraph, photoMorphology, modelMorphology) {
        console.time('🎯 centerMatcher_total');
        ...
        console.timeEnd('   step1_candidates');
        ...
        console.timeEnd('   step3_grouping');
        ...
        console.timeEnd('🎯 centerMatcher_total');
